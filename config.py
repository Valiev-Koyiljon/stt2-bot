...
LITELLM_BASE_URL = os.getenv("LITELLM_BASE_URL", "http://198.163.206.26:4000/v1")
LITELLM_API_KEY = os.getenv("LITELLM_API_KEY", "sk-mxQvLp7aoF1c94ZUxQ410A")
LITELLM_MULTIMODAL_MODEL = os.getenv("LITELLM_MULTIMODAL_MODEL", "qwen35-35b-direct")
